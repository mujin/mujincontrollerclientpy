...
class PlanningControllerClient(controllerclientbase.ControllerClient):
    ...
    def SetScenePrimaryKey(self, scenepk):
        ...
        sceneuri = uriutils.GetURIFromPrimaryKey(scenepk, primarykeyseparator='@', fragmentseparator='@')
        ...
        scenefilename = uriutils.GetFilenameFromURI(sceneuri, mujinpath, allowfragments=True, fragmentseparator='@')[1]
