...
# GENERATED AGAINST: mujinwebstack/2.0.133.cd1fc24a05da0b12311b3bc0b769d6629d98f21a-dirty
#
...
class ControllerGraphQueries:
    ...
    def ListAttachedSensors(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListAttachedSensors', parameterNameTypeValues=parameterNameTypeValues, returnType='AttachedSensor', fields=fields, timeout=timeout)
    ...
    def ListBodies(self, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListBodies', parameterNameTypeValues=parameterNameTypeValues, returnType='Body', fields=fields, timeout=timeout)
    ...
    def ListConnectedBodies(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListConnectedBodies', parameterNameTypeValues=parameterNameTypeValues, returnType='ConnectedBody', fields=fields, timeout=timeout)
    ...
    def ListEnvironments(self, pagination=None, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListEnvironments', parameterNameTypeValues=parameterNameTypeValues, returnType='Environment', fields=fields, timeout=timeout)
    ...
    def ListGeometries(self, bodyId, environmentId, linkId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListGeometries', parameterNameTypeValues=parameterNameTypeValues, returnType='Geometry', fields=fields, timeout=timeout)
    ...
    def ListGrabbeds(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListGrabbeds', parameterNameTypeValues=parameterNameTypeValues, returnType='Grabbed', fields=fields, timeout=timeout)
    ...
    def ListGraspSets(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListGraspSets', parameterNameTypeValues=parameterNameTypeValues, returnType='GraspSet', fields=fields, timeout=timeout)
    ...
    def ListGripperInfos(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListGripperInfos', parameterNameTypeValues=parameterNameTypeValues, returnType='GripperInfo', fields=fields, timeout=timeout)
    ...
    def ListIKParameterizations(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListIKParameterizations', parameterNameTypeValues=parameterNameTypeValues, returnType='IKParameterization', fields=fields, timeout=timeout)
    ...
    def ListJoints(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListJoints', parameterNameTypeValues=parameterNameTypeValues, returnType='Joint', fields=fields, timeout=timeout)
    ...
    def ListLinks(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListLinks', parameterNameTypeValues=parameterNameTypeValues, returnType='Link', fields=fields, timeout=timeout)
    ...
    def ListRevisions(self, environmentId, pagination=None, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListRevisions', parameterNameTypeValues=parameterNameTypeValues, returnType='Revision', fields=fields, timeout=timeout)
    ...
    def ListTools(self, bodyId, environmentId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListTools', parameterNameTypeValues=parameterNameTypeValues, returnType='Tool', fields=fields, timeout=timeout)
...
class ControllerGraphClient(ControllerGraphClientBase, ControllerGraphQueries, ControllerGraphMutations):
    ...
    typeDatabase = {
        ...
        # Optional pagination parameters, used to filter returned results.
        'PaginationInput': {
