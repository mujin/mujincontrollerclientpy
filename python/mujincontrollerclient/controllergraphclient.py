...
# GENERATED AGAINST: mujinwebstack/2.1.0.45f769d4aeb36ea01ed8534729c26016b73cf1a4
#
...
class ControllerGraphQueries:
    ...
    def GetApplication(self, applicationId, fields=None, timeout=None):
        ...
        Args:
            applicationId (String!): ID of an existing application.
...
class ControllerGraphMutations:
    ...
    def CopyLinkAndJoint(self, bodyId, environmentId, joint, link, linkId, parentLinkId, units=None, fields=None, timeout=None):
        ...
        Args:
            ...
            linkId (String!): ID of the existing link.
            parentLinkId (String!): ID of the parent link where copied link belongs to.
            units (UnitSelectionInput): Optional unit selection.
            fields (list or dict): Optionally specify a subset of fields to return.
            timeout (float): Number of seconds to wait for response.
    ...
    def CreateLinkAndJoint(self, bodyId, environmentId, link, joint=None, parentLinkId=None, units=None, fields=None, timeout=None):
        ...
        Args:
            ...
            joint (JointInput): Properties to be applied on the newly created joint. When creating base link, no joint will be created.
            parentLinkId (String): ID of the parent link, if any. When creating base link, do not supply parent link ID.
            units (UnitSelectionInput): Optional unit selection.
            fields (list or dict): Optionally specify a subset of fields to return.
            timeout (float): Number of seconds to wait for response.
...
These parameters are used only during planning - the values in SafetySpeedConstraintsInfo are used to limit speed during execution.
    ...
    def DeleteLinkAndJoint(self, bodyId, environmentId, linkId, fields=None, timeout=None):
    ...
    def ModifyReferenceObjectPKs(self, bodyId, environmentId, addDisabledReferenceObjectPks=None, addReferenceObjectPks=None, removeDisabledReferenceObjectPks=None, removeReferenceObjectPks=None, fields=None, timeout=None):
        """Modify reference object pks in a body.

        Args:
            bodyId (String!): ID of the body.
            environmentId (String!): ID of the environment.
            addDisabledReferenceObjectPks ([String!]): A list of reference object pks to add to the disable list.
            addReferenceObjectPks ([String!]): A list of reference object pks to add.
            removeDisabledReferenceObjectPks ([String!]): A list of reference object pks to remove from the disable list.
            removeReferenceObjectPks ([String!]): A list of reference object pks to remove.
            fields (list or dict): Optionally specify a subset of fields to return.
            timeout (float): Number of seconds to wait for response.
...
class ControllerGraphClient(ControllerGraphClientBase, ControllerGraphQueries, ControllerGraphMutations):
    ...
    typeDatabase = {
        ...
        'HypervisorDockerContainerStatus': {
        ...
        # information about docker image
        'HypervisorDockerImageStatus': {
        ...
        # status gotten from docker
        'HypervisorDockerStatus': {
            # whether there is any uncommitted changes to current running container
            'changes': 'Boolean', # Boolean!
            # running container status
            'container': 'HypervisorDockerContainerStatus', # HypervisorDockerContainerStatus
            # information about docker image
            'images': 'HypervisorDockerImageStatus', # [HypervisorDockerImageStatus!]!
        },
        ...
        'HypervisorStatus': {
            ...
            # docker status
            'docker': 'HypervisorDockerStatus', # HypervisorDockerStatus
            # hardware model
