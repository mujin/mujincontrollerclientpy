...
class RealtimeRobotControllerClient(planningclient.PlanningControllerClient):
    ...
    def RemoveObjectsWithPrefix(self, prefix=None, prefixes=None, objectPrefixesExpectingFromSlaveTrigger=None, timeout=10, usewebapi=None, fireandforget=False, blockwait=True, **kwargs):
    ...
    def SetRobotBridgeExternalIOPublishing(self, enable, usewebapi=False, timeout=1, fireandforget=False, **kwargs):
    ...
    def SetIgnoreObjectsFromUpdateWithPrefix(self, prefixes, usewebapi=False, timeout=1, fireandforget=False, blockwait=True, **kwargs):
        """enables publishing collision data to the robotbridge
        """
        taskparameters = {
        ...
        taskparameters.update(kwargs)
        return self.ExecuteCommand(taskparameters, usewebapi=usewebapi, timeout=timeout, fireandforget=fireandforget, blockwait=blockwait)
