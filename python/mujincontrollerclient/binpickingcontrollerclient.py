...
class BinpickingControllerClient(realtimerobotclient.RealtimeRobotControllerClient):
    ...
    def StopPickPlaceThread(self, resetExecutionState=True, resetStatusPickPlace=False, timeout=10, usewebapi=None, fireandforget=False, blockwait=True, **kwargs):
        ...
        taskparameters.update(kwargs)
        return self.ExecuteCommand(taskparameters, timeout=timeout, usewebapi=usewebapi, fireandforget=fireandforget, blockwait=blockwait)
    ...
    def SetStateSlaveTrigger(self, trigger, timeout=10, usewebapi=None, fireandforget=False, **kwargs):
        taskparameters = {'command': 'SetStateSlaveTrigger',
    ...
    def SetCycleLocationsProhibited(self, prohibited, timeout=10, usewebapi=None, fireandforget=False, **kwargs):
        taskparameters = {'command': 'SetCycleLocationsProhibited',
                          'prohibited': bool(prohibited)
                          }
        taskparameters.update(kwargs)
        return self.ExecuteCommand(taskparameters, timeout=timeout, usewebapi=usewebapi, fireandforget=fireandforget)
    
    def GetBinpickingState(self, timeout=10, usewebapi=None, robots=None, fireandforget=False, blockwait=True, **kwargs):
        taskparameters = {'command': 'GetBinpickingState'}
        taskparameters.update(kwargs)
        return self.ExecuteCommand(taskparameters, robots=robots, timeout=timeout, usewebapi=usewebapi, fireandforget=fireandforget, blockwait=blockwait)
    ...
    def ReplaceBodies(self, bodieslist, timeout=10, usewebapi=False, blockwait=True, fireandforget=False, **kwargs):
        """replaces bodies
        """
        ...
        taskparameters.update(kwargs)
        return self.ExecuteCommand(taskparameters, timeout=timeout, usewebapi=usewebapi, blockwait=blockwait, fireandforget=fireandforget)
