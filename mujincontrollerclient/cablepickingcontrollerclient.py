...
class CablepickingControllerClient(controllerclientbase.ControllerClientBase):
    ...
    sceneparams = {}
    def __init__(self, controllerurl, controllerusername, controllerpassword, robotControllerUri, cablepickingzmqport, cablepickingheartbeatport, cablepickingheartbeattimeout, scenepk, robotname, robotspeed, regionname, targetname, toolname, envclearance, usewebapi=False, initializezmq=False):
